...
package alzimerahmed84.keyboard.compat
...
object AppWorkarounds {
    ...
    fun adjustImeOptions(imeOptions: Int, packageName: String?): Int {
        return when (packageName) {
            ...
            // they would actually not perform the search action on action key. See https://github.com/alzimerahmed84/TypeCraft/issues/1989
