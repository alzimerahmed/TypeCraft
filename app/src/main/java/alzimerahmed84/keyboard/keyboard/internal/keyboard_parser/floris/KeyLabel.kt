...
import alzimerahmed84.keyboard.keyboard.internal.keyboard_parser.floris.KeyData.Companion.replaceIconWithLabelIfNoDrawable
...
object KeyLabel {
    ...
    fun String.convertFlorisLabel(): String = when (this) {
        ...
        "ime_ui_mode_media" -> toolbarKeyStrings[ToolbarKey.EMOJI] ?: "emoji"
        "ime_ui_mode_clipboard" -> toolbarKeyStrings[ToolbarKey.CLIPBOARD] ?: "clipboard"
