...
import alzimerahmed84.keyboard.keyboard.emoji.EmojiPageKeyboardView
...
import alzimerahmed84.keyboard.latin.suggestions.MoreSuggestions
import alzimerahmed84.keyboard.latin.suggestions.MoreSuggestionsView
import alzimerahmed84.keyboard.latin.utils.TypefaceUtils
...
open class KeyboardView @JvmOverloads constructor(
    ...
    private fun onDrawKeyboard(canvas: Canvas) {
        ...
        val floatingScale = alzimerahmed84.keyboard.latin.utils.ResourceUtils.getFloatingKeyboardScale()
        val floatingWidth = alzimerahmed84.keyboard.latin.utils.ResourceUtils.getFloatingKeyboardWidth()
        val defaultWidth = alzimerahmed84.keyboard.latin.utils.ResourceUtils.getDefaultKeyboardWidth(context)
    ...
    protected open fun onDrawKeyTopVisuals(key: Key, canvas: Canvas, paint: Paint, params: KeyDrawParams) {
        ...
        if (hintLabel != null && mShowsHints) {
            ...
            val labelCharHeight = TypefaceUtils.getReferenceCharHeight(paint)
            val labelCharWidth = TypefaceUtils.getReferenceCharWidth(paint)
            val isFunctionalKeyAndRoundedStyle = mColors.themeStyle == alzimerahmed84.keyboard.keyboard.KeyboardTheme.STYLE_ROUNDED && key.hasFunctionalBackground()
    ...
    protected open fun drawKeyPopupHint(key: Key, canvas: Canvas, paint: Paint, params: KeyDrawParams) {
        ...
        paint.textAlign = Paint.Align.CENTER
        val hintX = if (mColors.themeStyle == alzimerahmed84.keyboard.keyboard.KeyboardTheme.STYLE_ROUNDED) {
