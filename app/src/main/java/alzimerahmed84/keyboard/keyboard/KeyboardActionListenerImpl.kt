...
import alzimerahmed84.keyboard.event.HangulEventDecoder
import alzimerahmed84.keyboard.event.HapticEvent
import alzimerahmed84.keyboard.event.HardwareEventDecoder
import alzimerahmed84.keyboard.event.HardwareKeyboardEventDecoder
...
import alzimerahmed84.keyboard.latin.EmojiAltPhysicalKeyDetector
...
import alzimerahmed84.keyboard.latin.common.combiningRange
import alzimerahmed84.keyboard.latin.common.loopOverCodePoints
import alzimerahmed84.keyboard.latin.common.loopOverCodePointsBackwards
import alzimerahmed84.keyboard.latin.define.ProductionFlags
...
class KeyboardActionListenerImpl(private val latinIME: LatinIME, private val inputLogic: InputLogic) : KeyboardActionListener {
        ...
        when (primaryCode) {
            KeyCode.TOGGLE_SELECTION_MODE -> {
                ...
                keyboardSwitcher.suggestionStripView?.findViewById<android.view.ViewGroup>(R.id.toolbar)?.let {
                    alzimerahmed84.keyboard.latin.utils.setToolbarButtonsActivatedStateOnPrefChange(it, Settings.PREF_AUTO_CORRECTION)
                }
                return
            }
            KeyCode.ALPHA -> {
    ...
    /** keeps track of the state of meta keys by (TypeCraft) KeyCodes */
