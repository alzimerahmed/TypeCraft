...
import alzimerahmed84.keyboard.keyboard.internal.KeySpecParser
...
import alzimerahmed84.keyboard.keyboard.internal.PopupKeySpec
import alzimerahmed84.keyboard.keyboard.internal.keyboard_parser.floris.KeyCode
import alzimerahmed84.keyboard.keyboard.internal.keyboard_parser.floris.PopupSet
...
open class Key : Comparable<Key> {
    ...
    open class KeyParams {
        ...
        constructor(
            ...
            // popupKeys
            val popupKeys = alzimerahmed84.keyboard.latin.utils.createPopupKeysArray(
            ...
            if ((mLabelFlags and LABEL_FLAGS_DISABLE_HINT_LABEL) != 0) {
                ...
                val hintLabel = alzimerahmed84.keyboard.latin.utils.getHintLabel(popupSet, params, keySpec)
