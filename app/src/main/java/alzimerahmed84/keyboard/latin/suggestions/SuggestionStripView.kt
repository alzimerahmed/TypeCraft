...
import alzimerahmed84.keyboard.latin.AudioAndHapticFeedbackManager
...
import alzimerahmed84.keyboard.latin.common.Colors
...
import alzimerahmed84.keyboard.latin.utils.ToolbarKey
import alzimerahmed84.keyboard.latin.utils.ToolbarMode
import alzimerahmed84.keyboard.latin.utils.addPinnedKey
import alzimerahmed84.keyboard.latin.utils.createToolbarKey
import alzimerahmed84.keyboard.latin.utils.setToolbarButtonActivatedState
import alzimerahmed84.keyboard.latin.utils.isRepeatableToolbarKey
import alzimerahmed84.keyboard.latin.utils.RepeatableKeyTouchListener
import alzimerahmed84.keyboard.latin.utils.ResourceUtils
import alzimerahmed84.keyboard.latin.utils.dpToPx
import alzimerahmed84.keyboard.latin.utils.getCodeForToolbarKey
import alzimerahmed84.keyboard.latin.utils.getCodeForToolbarKeyLongClick
import alzimerahmed84.keyboard.latin.utils.getEnabledToolbarKeys
import alzimerahmed84.keyboard.latin.utils.getPinnedToolbarKeys
import alzimerahmed84.keyboard.latin.utils.prefs
import alzimerahmed84.keyboard.latin.utils.removeFirst
import alzimerahmed84.keyboard.latin.utils.removePinnedKey
import alzimerahmed84.keyboard.latin.utils.setToolbarButtonsActivatedStateOnPrefChange
import alzimerahmed84.keyboard.latin.utils.isMainDictionaryMissing
...
class SuggestionStripView(context: Context, attrs: AttributeSet?, defStyle: Int) :
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val isEmojiView = split && (isShowingEmojiSuggestions || alzimerahmed84.keyboard.keyboard.KeyboardSwitcher.getInstance().isShowingEmojiPalettes)
    ...
    fun setToolbarVisibility(toolbarVisible: Boolean, saveState: Boolean = false) {
        ...
        if (split) {
            ...
            val isEmojiView = isShowingEmojiSuggestions || alzimerahmed84.keyboard.keyboard.KeyboardSwitcher.getInstance().isShowingEmojiPalettes
    ...
    fun setSuggestions(suggestions: SuggestedWords, isRtlLanguage: Boolean) {
        ...
        if (isShowingEmojiSuggestions && !alzimerahmed84.keyboard.keyboard.KeyboardSwitcher.getInstance().isShowingEmojiPalettes) {
    ...
    override fun onVisibilityChanged(view: View, visibility: Int) {
        ...
        // workaround for a bug with inline suggestions views that just keep showing up otherwise, https://github.com/alzimerahmed84/TypeCraft/pull/386
        if (view === this) {
    ...
    private fun getLanguageHistory(prefs: SharedPreferences) = alzimerahmed84.keyboard.latin.utils.TranslationUtils.getLanguageHistory(prefs)

    private fun saveLanguageHistory(prefs: SharedPreferences, name: String, code: String) = alzimerahmed84.keyboard.latin.utils.TranslationUtils.saveLanguageHistory(prefs, name, code)

    private fun isSameLanguage(p1: Pair<String, String>, p2: Pair<String, String>) = alzimerahmed84.keyboard.latin.utils.TranslationUtils.isSameLanguage(p1, p2)
    ...
    fun showTranslateLanguageSelector() {
        ...
        val removed = alzimerahmed84.keyboard.latin.utils.TranslationUtils.getRemovedLanguages(prefs)
        ...
        for ((languageName, languageCode) in filteredList) {
            ...
            button.setOnClickListener {
                ...
                alzimerahmed84.keyboard.latin.utils.ProofreadService(context).setTargetLanguage(languageCode)
                ...
                dictDownloadButton = ImageButton(context, null, R.attr.suggestionWordStyle).apply {
                    ...
                    setOnClickListener {
                        val intent = android.content.Intent().apply {
                            setClass(context, alzimerahmed84.keyboard.settings.SettingsActivity2::class.java)
