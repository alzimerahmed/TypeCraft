...
import alzimerahmed84.keyboard.compat.ClipboardManagerCompat
...
import alzimerahmed84.keyboard.latin.common.isValidNumber
import alzimerahmed84.keyboard.latin.database.ClipboardDao
import alzimerahmed84.keyboard.latin.databinding.ClipboardSuggestionBinding
import alzimerahmed84.keyboard.latin.databinding.ScreenshotSuggestionBinding
import alzimerahmed84.keyboard.latin.ocr.OcrPluginLoader
import alzimerahmed84.keyboard.latin.ocr.OcrPipeline
import alzimerahmed84.keyboard.latin.ocr.ScreenshotHelper
...
class ClipboardHistoryManager(
    ...
    private fun updateLatestScreenshotCache(onComplete: (() -> Unit)? = null) {
        ...
        ExecutorUtils.getBackgroundExecutor(ExecutorUtils.KEYBOARD).execute {
            ...
            try {
                ...
                alzimerahmed84.keyboard.latin.utils.Log.e("ClipboardHistoryManager", "Failed to query screenshots in background", e)
            }
            cachedScreenshotInfo = null
            mainHandler.post {
                onComplete?.invoke()
    ...
    fun onCreate() {
        ...
        if (latinIME.prefs().getBoolean(alzimerahmed84.keyboard.latin.settings.Settings.PREF_ENABLE_CLIPBOARD_LISTENER, alzimerahmed84.keyboard.latin.settings.Defaults.PREF_ENABLE_CLIPBOARD_LISTENER)) {
    ...
    private fun cleanUpImageCache() {
        try {
            ...
            alzimerahmed84.keyboard.latin.utils.Log.e("ClipboardHistoryManager", "Failed to clean up image cache: " + e.message)
        }
    }
