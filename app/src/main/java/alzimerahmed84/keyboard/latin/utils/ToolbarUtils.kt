...
fun setToolbarButtonActivatedState(button: ImageButton) {
    val activated = when (button.tag) {
        ...
        SELECT_MODE -> alzimerahmed84.keyboard.keyboard.KeyboardActionListenerImpl.sPersistentSelectionModeActive
        else -> true
    }
...
val defaultToolbarPref by lazy {
    val default = when (alzimerahmed84.keyboard.latin.BuildConfig.FLAVOR) {
