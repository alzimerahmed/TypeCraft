...
object TranslationLoader {
    ...
    private const val PLUGIN_CLASS_NAME = "alzimerahmed84.keyboard.translation.plugin.TranslationProviderImpl"
    ...
    private class PluginClassLoader(
        ...
        override fun loadClass(name: String, resolve: Boolean): Class<*> {
            if (name.startsWith("alzimerahmed84.keyboard.translation.plugin.") ||
