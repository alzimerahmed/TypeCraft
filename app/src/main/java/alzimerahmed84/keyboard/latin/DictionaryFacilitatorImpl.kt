...
import alzimerahmed84.keyboard.latin.DictionaryFacilitator.DictionaryInitializationListener
import alzimerahmed84.keyboard.latin.NgramContext.WordInfo
import alzimerahmed84.keyboard.latin.SuggestedWords.SuggestedWordInfo
import alzimerahmed84.keyboard.latin.common.ComposedData
import alzimerahmed84.keyboard.latin.common.Constants
import alzimerahmed84.keyboard.latin.common.StringUtils
import alzimerahmed84.keyboard.latin.common.decapitalize
import alzimerahmed84.keyboard.latin.common.mightBeEmoji
import alzimerahmed84.keyboard.latin.common.splitOnWhitespace
import alzimerahmed84.keyboard.latin.define.DebugFlags
import alzimerahmed84.keyboard.latin.dictionary.AppsBinaryDictionary
import alzimerahmed84.keyboard.latin.dictionary.ContactsBinaryDictionary
...
import alzimerahmed84.keyboard.latin.dictionary.DictionaryStats
import alzimerahmed84.keyboard.latin.dictionary.ExpandableBinaryDictionary
import alzimerahmed84.keyboard.latin.dictionary.UserBinaryDictionary
import alzimerahmed84.keyboard.latin.permissions.PermissionsUtil
import alzimerahmed84.keyboard.latin.personalization.SessionWordBoost
import alzimerahmed84.keyboard.latin.personalization.UserHistoryDictionary
import alzimerahmed84.keyboard.latin.settings.Settings
import alzimerahmed84.keyboard.latin.settings.SettingsValuesForSuggestion
import alzimerahmed84.keyboard.latin.utils.Log
import alzimerahmed84.keyboard.latin.utils.SubtypeSettings
import alzimerahmed84.keyboard.latin.utils.SuggestionResults
...
class DictionaryFacilitatorImpl : DictionaryFacilitator {
    ...
    //  added in 12cbd43bda7d0f0cd73925e9cf836de751c32ed0 / https://github.com/alzimerahmed84/TypeCraft/issues/135
    ...
    override fun usesSameSettings(locales: List<Locale>, contacts: Boolean, apps: Boolean, personalization: Boolean): Boolean {
        ...
        val currentEmojiDictExists = locales.any { alzimerahmed84.keyboard.latin.utils.DictionaryInfoUtils.getCachedDictForLocaleAndType(it, Dictionary.TYPE_EMOJI, ctx) != null }
    ...
    private fun getNewDictGroupsAndDictsToCleanup(
        ...
        for (locale in newLocales) {
            ...
            val currentSuggestEmojis = Settings.getValues().mSuggestEmojis
            val currentEmojiDictExists = alzimerahmed84.keyboard.latin.utils.DictionaryInfoUtils.getCachedDictForLocaleAndType(locale, Dictionary.TYPE_EMOJI, context) != null
    ...
    private fun asyncReloadUninitializedMainDictionaries(
        ...
        scope.launch {
            try {
                ...
                mLoadedEmojiDictExists = locales.any { alzimerahmed84.keyboard.latin.utils.DictionaryInfoUtils.getCachedDictForLocaleAndType(it, Dictionary.TYPE_EMOJI, context) != null }
