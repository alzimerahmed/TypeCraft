...
import alzimerahmed84.keyboard.compat.ImeCompat.switchInputMethod
import alzimerahmed84.keyboard.compat.ImeCompat.switchInputMethodAndSubtypeCompat
import alzimerahmed84.keyboard.compat.ImeCompat.switchInputMethodCompat
...
import alzimerahmed84.keyboard.event.InputTransaction
...
import alzimerahmed84.keyboard.keyboard.KeyboardActionListenerImpl
import alzimerahmed84.keyboard.keyboard.KeyboardId
...
import alzimerahmed84.keyboard.keyboard.emoji.EmojiPalettesView
...
import alzimerahmed84.keyboard.latin.common.ColorType
import alzimerahmed84.keyboard.latin.common.Constants
import alzimerahmed84.keyboard.latin.common.CoordinateUtils
import alzimerahmed84.keyboard.latin.common.InputPointers
import alzimerahmed84.keyboard.latin.common.setInsetsOutlineProvider
import alzimerahmed84.keyboard.latin.define.DebugFlags
import alzimerahmed84.keyboard.latin.inputlogic.InputLogic
import alzimerahmed84.keyboard.latin.personalization.PersonalizationHelper
import alzimerahmed84.keyboard.latin.settings.Defaults
import alzimerahmed84.keyboard.latin.settings.Settings
import alzimerahmed84.keyboard.latin.settings.SettingsValues
import alzimerahmed84.keyboard.latin.suggestions.SuggestionStripView
import alzimerahmed84.keyboard.latin.suggestions.SuggestionStripViewAccessor
import alzimerahmed84.keyboard.latin.suggestions.VoiceVisualizerView
import alzimerahmed84.keyboard.latin.touchinputconsumer.GestureConsumer
import alzimerahmed84.keyboard.latin.utils.createInputMethodPickerDialog
import alzimerahmed84.keyboard.latin.utils.getDisplayContext
import alzimerahmed84.keyboard.latin.utils.isBrightColor
import alzimerahmed84.keyboard.latin.utils.prefs
import alzimerahmed84.keyboard.latin.utils.updateSoftInputWindowLayoutParameters
import alzimerahmed84.keyboard.latin.utils.DeviceProtectedUtils
import alzimerahmed84.keyboard.latin.utils.ExecutorUtils
import alzimerahmed84.keyboard.latin.utils.InlineAutofillUtils
import alzimerahmed84.keyboard.latin.utils.JniUtils
import alzimerahmed84.keyboard.latin.utils.LeakGuardHandlerWrapper
import alzimerahmed84.keyboard.latin.utils.LocaleUtils
import alzimerahmed84.keyboard.latin.utils.Log
import alzimerahmed84.keyboard.latin.utils.ProofreadHelper
import alzimerahmed84.keyboard.latin.utils.RecapitalizeMode
import alzimerahmed84.keyboard.latin.utils.ResourceUtils
import alzimerahmed84.keyboard.latin.utils.ScreenProfileProvider
import alzimerahmed84.keyboard.latin.utils.StatsUtils
import alzimerahmed84.keyboard.latin.utils.StatsUtilsManager
import alzimerahmed84.keyboard.latin.utils.SubtypeLocaleUtils
import alzimerahmed84.keyboard.latin.utils.SubtypeSettings
import alzimerahmed84.keyboard.latin.utils.SubtypeState
import alzimerahmed84.keyboard.latin.utils.ToolbarMode
import alzimerahmed84.keyboard.latin.voice.VoiceInputManager
import alzimerahmed84.keyboard.latin.voice.VoicePluginManager
import alzimerahmed84.keyboard.settings.SettingsActivity2
...
class LatinIME : InputMethodService(),
    ...
    private var insetsUpdater: alzimerahmed84.keyboard.latin.common.InsetsOutlineProvider? = null
    ...
    override fun pickSuggestionManually(suggestionInfo: SuggestedWordInfo?) {
        ...
        if (suggestionInfo.isEmoji || (suggestionInfo.mSourceDict != null && alzimerahmed84.keyboard.latin.dictionary.Dictionary.TYPE_EMOJI == suggestionInfo.mSourceDict.mDictType)) {
