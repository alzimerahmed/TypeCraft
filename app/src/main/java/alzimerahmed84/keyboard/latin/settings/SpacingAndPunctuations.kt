...
import alzimerahmed84.keyboard.latin.PunctuationSuggestions
...
import alzimerahmed84.keyboard.latin.common.getSecondInSymbolPair
import alzimerahmed84.keyboard.latin.common.toSortedCodepointArrays
...
class SpacingAndPunctuations(res: Resources, urlDetection: Boolean) {
    ...
    fun getSecondInSymbolPair(code: Int): Int {
        return alzimerahmed84.keyboard.latin.common.getSecondInSymbolPair(mPairSymbols, code)
    }
