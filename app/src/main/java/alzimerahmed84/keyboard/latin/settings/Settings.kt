...
package alzimerahmed84.keyboard.latin.settings
...
import alzimerahmed84.keyboard.latin.InputAttributes
import alzimerahmed84.keyboard.latin.R
import alzimerahmed84.keyboard.latin.RichInputMethodManager
import alzimerahmed84.keyboard.latin.RichInputMethodSubtype
import alzimerahmed84.keyboard.latin.common.StringUtils
import alzimerahmed84.keyboard.latin.utils.BitmapUtils
import alzimerahmed84.keyboard.latin.utils.CenterCropDrawable
...
import alzimerahmed84.keyboard.latin.utils.runInLocale
...
import alzimerahmed84.keyboard.latin.utils.clearCustomToolbarKeyCodes
import alzimerahmed84.keyboard.latin.utils.getCustomKeyCode
import alzimerahmed84.keyboard.latin.utils.getCustomLongpressKeyCode
...
class Settings private constructor() : SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onSharedPreferenceChanged(prefs: SharedPreferences?, key: String?) {
        ...
        try {
            ...
            alzimerahmed84.keyboard.latin.LatinIME.sSettingsDirty = true
        } finally {
    ...
    companion object {
        ...
        fun readSplitKeyboardEnabled(prefs: SharedPreferences, isLandscape: Boolean): Boolean {
            return readSplitKeyboardEnabled(prefs, isLandscape, alzimerahmed84.keyboard.latin.utils.ScreenProfile.COMPACT)
        }

        fun readSplitKeyboardEnabled(prefs: SharedPreferences, isLandscape: Boolean, profile: alzimerahmed84.keyboard.latin.utils.ScreenProfile): Boolean {
            val basePref = if (isLandscape) PREF_ENABLE_SPLIT_KEYBOARD_LANDSCAPE else PREF_ENABLE_SPLIT_KEYBOARD
        ...
        fun readHeightScale(prefs: SharedPreferences, landscape: Boolean): Float {
            return readHeightScale(prefs, landscape, alzimerahmed84.keyboard.latin.utils.ScreenProfile.COMPACT)
        }

        fun readHeightScale(prefs: SharedPreferences, landscape: Boolean, profile: alzimerahmed84.keyboard.latin.utils.ScreenProfile): Float {
            val index = findIndexOfDefaultSetting(landscape)
...
fun getProfileAwarePrefKey(key: String, profile: alzimerahmed84.keyboard.latin.utils.ScreenProfile): String =
    "${key}_${profile.name.lowercase()}"

fun getProfileAwareBoolean(prefs: SharedPreferences, key: String, profile: alzimerahmed84.keyboard.latin.utils.ScreenProfile, defaultValue: Boolean): Boolean {
...
fun getProfileAwareFloat(prefs: SharedPreferences, key: String, profile: alzimerahmed84.keyboard.latin.utils.ScreenProfile, defaultValue: Float): Float {
    val profileKey = getProfileAwarePrefKey(key, profile)
