...
import alzimerahmed84.keyboard.latin.utils.getHasLocalizedNumberRow
import alzimerahmed84.keyboard.latin.utils.getMoreKeys
import alzimerahmed84.keyboard.latin.utils.getPopupKeyLabelSources
import alzimerahmed84.keyboard.latin.utils.getPopupKeyTypes
import alzimerahmed84.keyboard.latin.utils.getSecondaryLocales
import java.util.Locale

/**
 * When you call the constructor of this class, you may want to change the current system locale by
 * using [alzimerahmed84.keyboard.latin.utils.RunInLocaleKt].
 */
...
open class SettingsValues(
    ...
    val mScreenProfile: alzimerahmed84.keyboard.latin.utils.ScreenProfile
    // From preferences
    ...
    init {
        ...
        mScreenProfile = alzimerahmed84.keyboard.latin.utils.ScreenProfileProvider.getScreenProfile(context, res.configuration, this)
