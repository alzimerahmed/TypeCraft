    ...
    fun startHandwriting(
        ...
        if (!hasPlugin) {
            ...
            if (button != null) {
                ...
                if ("standard" == alzimerahmed84.keyboard.latin.BuildConfig.FLAVOR || "standardfull" == alzimerahmed84.keyboard.latin.BuildConfig.FLAVOR) {
                    ...
                    button.setOnClickListener {
                        ...
                        intent.setClass(context, alzimerahmed84.keyboard.settings.SettingsActivity2::class.java)
                        intent.putExtra("screen", alzimerahmed84.keyboard.settings.SettingsDestination.Libraries)
            ...
            recognitionExecutor.execute {
                ...
                mainHandler.post {
                    if (!isReady) {
                        ...
                        val isOnlineFlavor = "standard" == alzimerahmed84.keyboard.latin.BuildConfig.FLAVOR || "standardfull" == alzimerahmed84.keyboard.latin.BuildConfig.FLAVOR
                        downloadProgress.visibility = View.GONE
                        if (isOnlineFlavor) {
                            ...
                            languageLabel.setOnClickListener {
                                val intent = android.content.Intent().apply {
                                    ...
                                    putExtra("screen", alzimerahmed84.keyboard.settings.SettingsDestination.Handwriting)
