...
object SoundPackImporter {
    ...
    val LEGACY_ID_MAP = mapOf(
        "dev.TypeCraft.sounds.gateron-oil-king-thock" to "dev.TypeCraft.sounds.thock",
        "dev.TypeCraft.sounds.gateron_oil_king_thock" to "dev.TypeCraft.sounds.thock",
        "dev.TypeCraft.sounds.kailh-box-jade-clicky" to "dev.TypeCraft.sounds.clicky",
        "dev.TypeCraft.sounds.kailh_box_jade_clicky" to "dev.TypeCraft.sounds.clicky",
        "dev.TypeCraft.sounds.holy-panda-tactile" to "dev.TypeCraft.sounds.tactile",
        "dev.TypeCraft.sounds.holy_panda_tactile" to "dev.TypeCraft.sounds.tactile",
        "dev.TypeCraft.sounds.ibm-model-m-beamspring" to "dev.TypeCraft.sounds.mechanical",
        "dev.TypeCraft.sounds.ibm_model_m_beamspring" to "dev.TypeCraft.sounds.mechanical",
        "dev.TypeCraft.sounds.classic-1930s-royal-typewriter" to "dev.TypeCraft.sounds.typewriter",
        "dev.TypeCraft.sounds.classic_1930s_royal_typewriter" to "dev.TypeCraft.sounds.typewriter",
        "dev.TypeCraft.sounds.creamy-linear-jelly" to "dev.TypeCraft.sounds.creamy",
        "dev.TypeCraft.sounds.creamy_linear_jelly" to "dev.TypeCraft.sounds.creamy",
        "dev.TypeCraft.sounds.8-bit-chiptune-arcade" to "dev.TypeCraft.sounds.chiptune",
        "dev.TypeCraft.sounds.arcade_8bit_chiptune" to "dev.TypeCraft.sounds.chiptune",
        "dev.TypeCraft.sounds.minimalistic-ceramic-glass-marble" to "dev.TypeCraft.sounds.glass",
        "dev.TypeCraft.sounds.minimalistic_ceramic_glass_marble" to "dev.TypeCraft.sounds.glass",
        "dev.TypeCraft.sounds.water-bubble-pop" to "dev.TypeCraft.sounds.bubble",
        "dev.TypeCraft.sounds.water_bubble_pop" to "dev.TypeCraft.sounds.bubble",
        "dev.TypeCraft.sounds.acoustic-teak-woodblock" to "dev.TypeCraft.sounds.woodblock",
        "dev.TypeCraft.sounds.acoustic_teak_woodblock" to "dev.TypeCraft.sounds.woodblock",
        "dev.TypeCraft.sounds.grand-piano" to "dev.TypeCraft.sounds.piano",
        "dev.TypeCraft.sounds.nylon-guitar" to "dev.TypeCraft.sounds.acoustic-pluck",
        "dev.TypeCraft.sounds.kerala-chenda" to "dev.TypeCraft.sounds.folk-drum",
        "dev.TypeCraft.sounds.carnatic-mridangam" to "dev.TypeCraft.sounds.resonant-drum",
        "dev.TypeCraft.sounds.kalimba-tines" to "dev.TypeCraft.sounds.kalimba",
        "dev.TypeCraft.sounds.orchestral-pizzicato" to "dev.TypeCraft.sounds.pizzicato"
    )
