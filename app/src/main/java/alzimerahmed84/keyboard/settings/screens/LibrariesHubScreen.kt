...
import alzimerahmed84.keyboard.latin.sound.SoundPackImporter
import alzimerahmed84.keyboard.latin.sound.SoundPackUrls
                ...
                Card(
                    ...
                    Column {
                        ...
                        if (isOfflineAiSupported) {
                            val aiPluginInstalled = alzimerahmed84.keyboard.latin.ai.OfflineAiLoader.hasPlugin(context)
                            val aiSummary = when {
                                aiPluginInstalled -> {
                                    val version = alzimerahmed84.keyboard.latin.ai.OfflineAiLoader.getPluginVersion(context)
                        ...
                        // Offline Voice Input
                        val voicePluginManager = remember { alzimerahmed84.keyboard.latin.voice.VoicePluginManager(context) }
