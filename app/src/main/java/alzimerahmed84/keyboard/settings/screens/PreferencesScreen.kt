...
import alzimerahmed84.keyboard.settings.preferences.ReorderSwitchPreference
...
fun createPreferencesSettings(context: Context) = listOf(
    ...
    Setting(context, Settings.PREF_CLEAR_CLIPBOARD_ICON, R.string.clear_clipboard_icon) { setting ->
        ...
        ListPreference(
            ...
            alzimerahmed84.keyboard.keyboard.internal.KeyboardIconsSet.needsReload = true
            alzimerahmed84.keyboard.keyboard.internal.KeyboardIconsSet.instance.loadIcons(ctx)
            KeyboardSwitcher.getInstance().setThemeNeedsReload()
        }
    },
