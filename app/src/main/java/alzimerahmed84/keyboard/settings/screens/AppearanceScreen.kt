...
import alzimerahmed84.keyboard.settings.dialogs.ColorThemePickerDialog
import alzimerahmed84.keyboard.settings.dialogs.CustomizeIconsDialog
import alzimerahmed84.keyboard.settings.initPreview
import alzimerahmed84.keyboard.settings.preferences.BackgroundImagePref
import alzimerahmed84.keyboard.settings.preferences.CustomFontPreference
...
fun createAppearanceSettings(context: Context) = listOf(
    ...
    Setting(context, Settings.PREF_FOLDABLE_MODE, R.string.pref_foldable_mode_title, R.string.pref_foldable_mode_summary) {
        SwitchPreference(it, false) {
            alzimerahmed84.keyboard.latin.utils.ScreenProfileProvider.invalidateCache()
