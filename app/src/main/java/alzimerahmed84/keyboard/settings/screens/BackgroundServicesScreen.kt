...
import alzimerahmed84.keyboard.settings.BackButton
...
fun createBackgroundServicesSettings(context: android.content.Context): List<alzimerahmed84.keyboard.settings.Setting> = listOf(
    alzimerahmed84.keyboard.settings.Setting(
        ...
        alzimerahmed84.keyboard.settings.preferences.SwitchPreference(
            name = setting.title,
            key = setting.key,
