...
import alzimerahmed84.keyboard.latin.common.default
...
import alzimerahmed84.keyboard.settings.CloseIcon
...
import alzimerahmed84.keyboard.settings.dialogs.ColorPickerDialog
...
//                supportingText = { if (!nameValid) Text(stringResource(R.string.name_invalid)) } // todo: this is cutting off bottom half of the actual text...
        ...
        menu = listOf(
            ...
            stringResource(R.string.copy_to_clipboard) to {
                ...
                cm.setPrimaryClip(ClipData.newPlainText("TypeCraft theme", getColorString(prefs, newThemeName.text)))
            },
        ),
