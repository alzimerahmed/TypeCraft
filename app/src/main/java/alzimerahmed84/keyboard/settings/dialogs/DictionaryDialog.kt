...
import alzimerahmed84.keyboard.latin.utils.createDictionaryTextAnnotated
import alzimerahmed84.keyboard.latin.utils.DownloadableDictionaryRow
import alzimerahmed84.keyboard.settings.DeleteButton
import alzimerahmed84.keyboard.settings.ExpandButton
...
import alzimerahmed84.keyboard.settings.screens.getUserAndInternalDictionaries
import java.io.File
        ...
        content = {
            Column {
                ...
                val knownDicts = remember {
                    alzimerahmed84.keyboard.latin.utils.getKnownDictionariesForLocale(locale, ctx)
                }
