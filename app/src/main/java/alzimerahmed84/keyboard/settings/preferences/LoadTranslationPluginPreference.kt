...
package alzimerahmed84.keyboard.settings.preferences
...
import alzimerahmed84.keyboard.latin.translation.TranslationLoader
import alzimerahmed84.keyboard.settings.FeedbackManager
import alzimerahmed84.keyboard.settings.dialogs.PreferenceDialog
import alzimerahmed84.keyboard.settings.filePicker
...
fun TranslationModePreference() {
    ...
    val setting = remember {
        alzimerahmed84.keyboard.settings.Setting(
...
fun TranslationEnginePreference() {
    val ctx = LocalContext.current
    val isOfflineFlavor = alzimerahmed84.keyboard.latin.BuildConfig.FLAVOR == "offline"
    ...
    val setting = remember {
        alzimerahmed84.keyboard.settings.Setting(
            ctx,
            alzimerahmed84.keyboard.settings.SettingsWithoutKey.TRANSLATION_ENGINE,
...
fun TranslationTargetLanguagePreference() {
    ...
    val setting = remember {
        alzimerahmed84.keyboard.settings.Setting(
            ctx,
            alzimerahmed84.keyboard.settings.SettingsWithoutKey.GEMINI_TARGET_LANGUAGE,
            ...
            if (showPickerDialog) {
                alzimerahmed84.keyboard.settings.dialogs.ConfirmationDialog(
                                    ...
                                    TextButton(
                                        onClick = {
                                            ...
                                            ctx.prefs().edit().apply {
                                                putString(alzimerahmed84.keyboard.settings.SettingsWithoutKey.GEMINI_TARGET_LANGUAGE, code)
                                                putString(alzimerahmed84.keyboard.latin.settings.Settings.PREF_OFFLINE_TRANSLATE_TARGET_LANGUAGE, name)
                                            }.apply()
                ...
                alzimerahmed84.keyboard.settings.dialogs.ConfirmationDialog(
                    ...
                    onConfirmed = {
                        if (customLangName.isNotBlank() && customLangCode.isNotBlank()) {
                            ...
                            alzimerahmed84.keyboard.latin.utils.TranslationUtils.saveLanguageHistory(ctx.prefs(), cleanName, cleanCode)
                            ctx.prefs().edit().apply {
                                putString(alzimerahmed84.keyboard.settings.SettingsWithoutKey.GEMINI_TARGET_LANGUAGE, cleanCode)
                                putString(alzimerahmed84.keyboard.latin.settings.Settings.PREF_OFFLINE_TRANSLATE_TARGET_LANGUAGE, cleanName)
                            }.apply()
