...
/**
 * Offline proofreading service using modular TypeCraft-Offline-AI-Plugin with GGUF models.
 */
class ProofreadService(private val context: Context) {
    ...
    fun setTargetLanguage(language: String) {
        sharedPrefs.edit()
            .putString(alzimerahmed84.keyboard.settings.SettingsWithoutKey.GEMINI_TARGET_LANGUAGE, language)
