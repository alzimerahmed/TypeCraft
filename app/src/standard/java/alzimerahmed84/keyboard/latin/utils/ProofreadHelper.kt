...
object ProofreadHelper {
    ...
    fun translateAsync(
        ...
        val hasPlugin = alzimerahmed84.keyboard.latin.translation.TranslationLoader.hasPlugin(context)
        ...
        performAsyncOperation(
            ...
            apiCall = { service ->
                val pluginProvider = if (usePlugin) alzimerahmed84.keyboard.latin.translation.TranslationLoader.getProvider(context) else null
                ...
                if (pluginProvider != null && pluginProvider.isAvailable()) {
                    ...
                    if (sourceLangCode != "auto" && sourceLangCode != "en") {
                        val isDownloaded = try {
                            ...
                            false
                        } || alzimerahmed84.keyboard.latin.translation.TranslationModelImporter.isModelInstalled(context, sourceLangCode)
                        if (!isDownloaded) {
                    ...
                    if (targetLangCode != "en" && !missingModels.contains(targetLangCode)) {
                        val isDownloaded = try {
                            ...
                            false
                        } || alzimerahmed84.keyboard.latin.translation.TranslationModelImporter.isModelInstalled(context, targetLangCode)
                        if (!isDownloaded) {
