### 💖 Support Our Work
As an open-source, community-funded project, we operate on a very limited budget and have little time for marketing. If TypeCraft helps you daily, please consider becoming a [sponsor](https://github.com/sponsors/alzimerahmed84). Even if you can't contribute financially, sharing TypeCraft with your friends, family, or on social media makes a world of difference to help our project grow. Thank you for your support!
...
| :--- | :--- | :--- |
| **`1-TypeCraft_4.1.1-standardfull-release.apk`** | **Recommended**. Cloud AI + Handwrite  | Internet | 
| **`1-TypeCraft_4.1.1-standard-release.apk`** | **Fdroid Build**. Standard - Foss only | Internet |
| **`2-TypeCraft_4.1.1-offline-release.apk`** | **Privacy Focused**. Offline AI | No Internet |
| **`3-TypeCraft_4.1.1-offlinelite-release.apk`** | **Minimalist**. Pure FOSS. No AI Integration. | No Internet |
