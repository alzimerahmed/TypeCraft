...
- **Unified Offline Edition (`minSdk = 21`)**: Consolidated `offline` and `offlinelite` into a single lightweight **Offline** edition (`com.Alzimer Ahmed.TypeCraft.offline`). Supports Android 5.0+ with modular plugin OS version guards (`API 26+` for Offline AI and Handwriting, `API 24+` for Translation).
...
|:----------------------------------------------- |:------------------------------ |:---------------- |:------------------------------ |:-------------------------------- |:-------------------- |
| **`1-TypeCraft_4.1.7-standardfull-release.apk`** | **Convenience (Recommended)**  | Cloud AI         | In-app download or File import | Optional (AI/Updates/plugins)    | ✅ In-App Auto Update |
| **`1-TypeCraft_4.1.7-standard-release.apk`**     | **F-Droid**                    | Cloud AI         | In-app download or File import | Optional (AI/plugins)            | ❌ None               |
| **`2-TypeCraft_4.1.7-offline-release.apk`**      | **Offline**                    | Local LLM Plugin (8.0+) | Browser download + File import | 🚫 Zero Internet (No Permission) | ❌ None               |
