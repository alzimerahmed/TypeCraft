...
| :--- | :--- | :--- |
| **`1-TypeCraft_4.0.7-standardfull-release.apk`** | **Recommended**. Cloud AI + Handwrite  | Internet | 
| **`1-TypeCraft_4.0.7-standard-release.apk`** | **Fdroid Build**. Standard - Foss only | Internet |
| **`2-TypeCraft_4.0.7-offline-release.apk`** | **Privacy Focused**. Offline AI | No Internet |
| **`3-TypeCraft_4.0.7-offlinelite-release.apk`** | **Minimalist**. Pure FOSS. No AI Integration. | No Internet |
