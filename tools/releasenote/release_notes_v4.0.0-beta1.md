...
| :--- | :--- | :--- |
| **`1-TypeCraft_4.0.0-beta1-standardfull-debug.apk`** | **Recommended**. Cloud AI + Handwrite  | Internet | 
| **`1-TypeCraft_4.0.0-beta1-standard-debug.apk`** | **Fdroid Build**. Standard - Foss only | Internet |
| **`2-TypeCraft_4.0.0-beta1-offline-debug.apk`** | **Privacy Focused**. Offline AI | No Internet |
| **`3-TypeCraft_4.0.0-beta1-offlinelite-debug.apk`** | **Minimalist**. Pure FOSS. No AI Integration. | No Internet |
