...
| :--- | :--- | :--- |
| **`1-TypeCraft_4.1.0-standardfull-release.apk`** | **Recommended**. Cloud AI + Handwrite  | Internet | 
| **`1-TypeCraft_4.1.0-standard-release.apk`** | **Fdroid Build**. Standard - Foss only | Internet |
| **`2-TypeCraft_4.1.0-offline-release.apk`** | **Privacy Focused**. Offline AI | No Internet |
| **`3-TypeCraft_4.1.0-offlinelite-release.apk`** | **Minimalist**. Pure FOSS. No AI Integration. | No Internet |
