...
| :--- | :--- | :--- |
| **`1-TypeCraft_3.9.0-standardfull-release.apk`** | **Recommended**. Cloud AI | Internet | 
| **`1-TypeCraft_3.9.0-standard-release.apk`** | **Fdroid Build**. Standard + No Handwrite | Internet |
| **`2-TypeCraft_3.9.0-offline-release.apk`** | **Privacy Focused**. No Internet. Offline AI Only. | No Internet |
| **`3-TypeCraft_3.9.0-offlinelite-release.apk`** | **Minimalist**. Pure FOSS. No AI code. | No Internet |
