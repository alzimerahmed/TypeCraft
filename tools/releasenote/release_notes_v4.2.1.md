...
As an open-source, community-funded project, we operate on a very limited budget. If TypeCraft helps you daily, please consider supporting us on [GitHub Sponsors](https://github.com/sponsors/alzimerahmed84) or [Open Collective](https://opencollective.com/alzimerahmed84). Sharing TypeCraft with friends and family makes a huge difference!
...
|:---|:---|:---|:---|:---|:---|
| **`1-TypeCraft_4.2.1-standardfull-release.apk`** | **Convenience (Recommended)** | Cloud AI | In-app download or File import | Optional (AI/Updates/plugins) | ✅ In-App Auto Update |
| **`1-TypeCraft_4.2.1-standard-release.apk`** | **F-Droid** | Cloud AI | In-app download or File import | Optional (AI/plugins) | ❌ None |
| **`2-TypeCraft_4.2.1-offline-release.apk`** | **Offline** | Local LLM Plugin (8.0+) | Browser download + File import | 🚫 Zero Internet (No Permission) | ❌ None |
