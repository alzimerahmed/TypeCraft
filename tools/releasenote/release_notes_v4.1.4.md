...
|:----------------------------------------------- |:---------------- |:---------------- |:------------------------------ |:-------------------------------- |:-------------------- |
| **`1-TypeCraft_4.1.4-standardfull-release.apk`** | **Recommended**  | Cloud AI         | In-app download or File import | Optional ( AI/Updates/plugins)   | ✅ In-App Auto Update |
| **`1-TypeCraft_4.1.4-standard-release.apk`**     | **F-Droid**      | Cloud AI         | In-app download or File import | Optional ( AI/plugins)           | ❌ None               |
| **`2-TypeCraft_4.1.4-offline-release.apk`**      | **Offline AI**   | Local LLM (GGUF) | Browser download + File import | 🚫 Zero Internet (No Permission) | ❌ None               |
| **`3-TypeCraft_4.1.4-offlinelite-release.apk`**  | **Offline Lite** | None             | Browser download + File import | 🚫 Zero Internet (No Permission) | ❌ None               |
