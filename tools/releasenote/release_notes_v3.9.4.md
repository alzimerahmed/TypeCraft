...
| :--- | :--- | :--- |
| **`1-TypeCraft_3.9.4-standardfull-release.apk`** | **Recommended**. Cloud AI + Handwrite  | Internet | 
| **`1-TypeCraft_3.9.4-standard-release.apk`** | **Fdroid Build**. Standard - Foss only | Internet |
| **`2-TypeCraft_3.9.4-offline-release.apk`** | **Privacy Focused**. Offline AI | No Internet |
| **`3-TypeCraft_3.9.4-offlinelite-release.apk`** | **Minimalist**. Pure FOSS. No AI Integration. | No Internet |
