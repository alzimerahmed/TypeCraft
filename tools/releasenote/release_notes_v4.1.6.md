...
- **Modular Offline AI Dynamic Plugin**: Decoupled the local GGUF AI engine into a standalone dynamic plugin (`TypeCraft-Offline-AI-Plugin`), keeping the core keyboard fast and lean.
...
> - **Offline AI Plugin Detachment**: The local GGUF AI engine is now modularized into the standalone [**`TypeCraft-Offline-AI-Plugin`**](https://github.com/alzimerahmed84/TypeCraft-Offline-AI-Plugin). Existing **Offline** flavor users are recommended to **backup their settings** (**Settings &rarr; Advanced &rarr; Backup**) before updating just in case. After updating, simply load the Offline AI Plugin from **Settings &rarr; Plugins &rarr; Offline AI** to continue using local GGUF model proofreading.
...
|:----------------------------------------------- |:------------------------------ |:---------------- |:------------------------------ |:-------------------------------- |:-------------------- |
| **`1-TypeCraft_4.1.6-standardfull-release.apk`** | **Convenience (Recommended)**  | Cloud AI         | In-app download or File import | Optional (AI/Updates/plugins)    | ✅ In-App Auto Update |
| **`1-TypeCraft_4.1.6-standard-release.apk`**     | **F-Droid**                    | Cloud AI         | In-app download or File import | Optional (AI/plugins)            | ❌ None               |
| **`2-TypeCraft_4.1.6-offline-release.apk`**      | **Offline**                    | Local LLM Plugin (8.0+) | Browser download + File import | 🚫 Zero Internet (No Permission) | ❌ None               |
