...
| :--- | :--- | :--- |
| **`1-TypeCraft_3.9.9-standardfull-release.apk`** | **Recommended**. Cloud AI + Handwrite  | Internet | 
| **`1-TypeCraft_3.9.9-standard-release.apk`** | **Fdroid Build**. Standard - Foss only | Internet |
| **`2-TypeCraft_3.9.9-offline-release.apk`** | **Privacy Focused**. Offline AI | No Internet |
| **`3-TypeCraft_3.9.9-offlinelite-release.apk`** | **Minimalist**. Pure FOSS. No AI Integration. | No Internet |
